...
def Assertions(driver):
    assertExpectedConditionTrue(driver, "By.XPATH", "//table[@id='alarmsInfoTable']/tbody/tr[5][@style='color: darkorange;']/td[4]")
    assertExpectedConditionTrue(driver, "By.XPATH", "//table[@id='alarmsInfoTable']/tbody/tr[9][@style='color: darkorange;']/td[4]") 
...
def test_settingsUsersGroupsAlarmingGroups5(driver, url):
