...
# Control 3
def CreateControlUser4(driver):
    insert_text(driver,"By.ID", "username", "nate_control4")
...
def TestAccount4(driver):
    # Logging in:
    insert_text(driver, "By.XPATH", "//input[@id='username']", "nate_control4")
    insert_text(driver, "By.ID", "password", "123$Asdfnovatech!")
    ...
    # ASSERTS Breaker 4 (Working):
    click_action_chains(driver, "By.ID", "tspan14345", "BREAKER CONTROL")
    assertExpectedConditionTrue(driver, "By.XPATH", "//p[contains(.,'Control Feeder4 Breaker')]")
...
def TearDown(driver):
    ...
    # Delete
    click(driver, "By.XPATH", "//a[contains(text(),'nate_control4')]")
    click(driver, "By.XPATH", "//input[@name='deleteuser']")
    click(driver, "By.XPATH", "//input[@name='deleteuser']")


def test_settingsUsersGroupsControl4(driver, url):
