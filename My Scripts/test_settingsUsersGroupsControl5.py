...
# Control 5
def CreateControlUser5(driver):
    insert_text(driver,"By.ID", "username", "nate_control5")
...
def TestAccount5(driver):
    # Logging in:
    insert_text(driver, "By.XPATH", "//input[@id='username']", "nate_control5")
    insert_text(driver, "By.ID", "password", "123$Asdfnovatech!")
...
def TearDown(driver):
   ...
   # assertURL(driver, "/Home", 4)
    ...
    # Delete
    click(driver, "By.XPATH", "//a[contains(text(),'nate_control5')]")
    click(driver, "By.XPATH", "//input[@name='deleteuser']")
    click(driver, "By.XPATH", "//input[@name='deleteuser']")


def test_settingsUsersGroupsControl5(driver, url):
