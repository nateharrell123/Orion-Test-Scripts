...
# Alarm1
def CreateAlarmUser1(driver):
    insert_text(driver,"By.ID", "username", "nate_alarming1")
...
def TestAccount1(driver):
    ...
    insert_text(driver, "By.XPATH", "//input[@id='username']", "nate_alarming1")
    insert_text(driver, "By.ID", "password", "123$Asdfnovatech!")
...
def TearDown(driver):
    ...
    # Delete
    click(driver, "By.XPATH", "//a[contains(text(),'nate_alarming1')]")
...
def test_settingsUsersGroupsAlarmingGroups1_2(driver, url):
