...
# Alarm 4
def CreateAlarmUser4(driver):
    insert_text(driver,"By.ID", "username", "nate_alarming4")
...
def Assertions(driver):
    assertExpectedConditionTrue(driver, "By.XPATH", "//table[@id='alarmsInfoTable']/tbody/tr[1][@style='color: darkorange;']/td[4]")
    assertExpectedConditionTrue(driver, "By.XPATH", "//table[@id='alarmsInfoTable']/tbody/tr[6][@style='color: darkorange;']/td[4]") 


def TestAccount4(driver):
    click(driver, "By.XPATH", "//a[contains(text(),'Logout')]")
    insert_text(driver, "By.XPATH", "//input[@id='username']", "nate_alarming4")
    insert_text(driver, "By.ID", "password", "123$Asdfnovatech!")
...
def TearDown(driver):
    ...
    click(driver, "By.XPATH", "//a[contains(text(),'nate_alarming4')]")
...
def test_settingsUsersGroupsAlarmingGroups4(driver, url):
