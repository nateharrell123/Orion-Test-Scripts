...
# Alarm3
def CreateAlarmUser3(driver):
    insert_text(driver,"By.ID", "username", "nate_alarming3")
    insert_text(driver, "By.ID", "password", "123$Asdfnovatech!")
    insert_text(driver, "By.ID", "verifypassword", "123$Asdfnovatech!")
    checkboxes = driver.find_elements_by_name("groups")
...
def Assertions(driver):
    assertExpectedConditionTrue(driver, "By.XPATH", "//table[@id='alarmsInfoTable']/tbody/tr[2][@style='color: darkorange;']/td[4]")
    assertExpectedConditionTrue(driver, "By.XPATH", "//table[@id='alarmsInfoTable']/tbody/tr[7][@style='color: darkorange;']/td[4]") 


def TestAccount3(driver):
    click(driver, "By.XPATH", "//a[contains(text(),'Logout')]")
    insert_text(driver, "By.XPATH", "//input[@id='username']", "nate_alarming3")
    insert_text(driver, "By.ID", "password", "123$Asdfnovatech!")
...
def TearDown(driver):
    ...
    click(driver, "By.XPATH", "//a[contains(text(),'nate_alarming3')]")
...
def test_settingsUsersGroupsAlarmingGroups3(driver, url):
