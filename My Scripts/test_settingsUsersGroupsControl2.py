...
# Control 2
def CreateControlUser2(driver):
    insert_text(driver,"By.ID", "username", "nate_control2")
...
def TestAccount2(driver):
    # Logging in:
    insert_text(driver, "By.XPATH", "//input[@id='username']", "nate_control2")
    insert_text(driver, "By.ID", "password", "123$Asdfnovatech!")
    ...
    # ASSERTS Recloser 2 (Working):
    click(driver, "By.ID", "rect2417"); 
    if global_vars.platform_version == "lxplus":
        click(driver, "By.ID", "rect12699")
    else:
        click(driver, "By.ID", "rect12685");
    assertExpectedConditionTrue(driver, "By.XPATH", "//p[contains(.,'Control Feeder2 Breaker')]")
...
def TearDown(driver):
    ...
    # Delete
    click(driver, "By.XPATH", "//a[contains(text(),'nate_control2')]")
    click(driver, "By.XPATH", "//input[@name='deleteuser']")
    click(driver, "By.XPATH", "//input[@name='deleteuser']")


def test_settingsUsersGroupsControl2(driver, url):
