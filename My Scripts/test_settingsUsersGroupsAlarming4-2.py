...
def Assertions(driver):
    ...
    assertExpectedConditionTrue(driver, "By.XPATH", "//td[contains(.,'alarm5 @Logic')]")
    ...
    assertExpectedConditionTrue(driver, "By.XPATH", "//td[contains(.,'alarm10 @Logic')]")
...
def test_settingsUsersGroupsAlarmingGroups4_2(driver, url):
